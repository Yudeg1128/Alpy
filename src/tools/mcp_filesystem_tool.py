...
class MCPFileSystemTool(BaseTool, BaseModel): # Inherit from BaseModel for Pydantic features
    ...
    description: str = (
        "Interacts with an MCP filesystem server to perform various file operations. "
        "Input should be a JSON object specifying the 'action' and other relevant parameters like 'uri', 'content', etc."
    )
